        ...
        <div className="w-full max-w-lg max-h-[min(90dvh,40rem)] overflow-y-auto rounded-xl bg-white p-4 shadow-xl sm:p-6">
          ...
          <div className="mt-6 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
            ...
            <button
              ...
              className={
                mode === 'delete'
                  ? 'rounded-lg bg-red-600 px-4 py-2 text-sm font-medium text-white hover:bg-red-700 active:bg-red-800 disabled:opacity-60'
                  : 'rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 active:bg-blue-800 disabled:opacity-60'
              }
            >
              {isSubmitting
                ? 'Working…'
