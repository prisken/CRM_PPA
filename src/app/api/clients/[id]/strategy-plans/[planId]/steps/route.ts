...
export async function POST(
  ...
  const step = await prisma.clientStrategyStep.create({
    data: {
      ...
      incomeAmount: parsed.data.incomeAmount ?? null,
      incomeFrequency: parsed.data.incomeFrequency ?? null,
      incomeStartYear: parsed.data.incomeStartYear ?? null,
      incomeEndYear: parsed.data.incomeEndYear ?? null,
      capitalReturned: parsed.data.capitalReturned ?? null,
      capitalReturnYear: parsed.data.capitalReturnYear ?? null,
      sortOrder,
    },
